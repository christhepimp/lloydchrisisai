...
### +10$ (high priority + context spread) — ~1437 words
- coding / programming
- hacking / security
...
### +7$ (pattern indicators / relational connectors) — ~212 words
...
- **Causality/Logic:** because, therefore, cause, effect, if, then, since, hence, leads, …
- **Frequency:** always, often, sometimes, never, usually, typically, tends, habit, …
